...
function Navbar() {
  ...
  const handleLogout = async () => {
    try {
      ...
      await showAlert("Logout Success", "Success");
    } catch (error) {
      console.log(error);
  ...
  return (
    <>
      <div>
        <div className="flex flex-row justify-between items-center p-5 sm:p-7 bg-white rounded-b-2xl shadow-xl">
          <Link to="/">
            <svg
              id="logo-45"
              className="gradient h-7 sm:h-8"
              viewBox="0 0 160 32"
              fill="none"
            ...
            >
              ...
              <defs>
                ...
                >
                  <stop className="ccustom" stopColor="#73E5E2"></stop>
                  <stop
                    className="ccompli1"
                    offset="1"
                    stopColor="#394F87"
                ...
                <linearGradient
                  ...
                  gradientUnits="userSpaceOnUse"
                >
                  <stop className="ccompli1" stopColor="#FBDC8E"></stop>
                  <stop
                    className="ccompli2"
                    offset="1"
                    stopColor="#FB958E"
          ...
          <nav className="hidden sm:flex sm:flex-row sm:gap-4 md:gap-6">
            <NavLink
              to="/"
              className="font-sans font-semibold text-xl text-[#394F87]"
            >
              Home
            </NavLink>
            <NavLink
              to="/products"
              className="font-sans font-semibold text-xl text-[#394F87] active:text-[#0f214f]"
            >
              Products
            </NavLink>
            <NavLink
          ...
          <div className="hidden sm:flex sm:flex-row sm:gap-4 items-center ">
            {localStorage.getItem("token") ? (
              <>
                ...
                <div
                  className="px-4 py-2 bg-[#394F87] rounded-lg hover:cursor-pointer"
              ...
              <>
                <Link
                  to="/login"
                  className="px-4 py-2 ring-1 ring-[#394F87] rounded-lg"
                >
                  <div className="font-sans font-semibold text-xl text-[#394F87]">
                    Login
                  </div>
          ...
          <div onClick={handleDrawer.bind(this, true)} className="sm:hidden">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
        ...
        {drawer === true ? (
          <div className="fixed flex flex-col top-0 left-0 right-0 w-full h-full bg-black bg-opacity-80 py-6 px-6 sm:hidden z-50">
            <div className="flex flex-row justify-center relative pb-6">
              <Link to="/">
                <svg
                  id="logo-45"
                  className="gradient h-7 sm:h-8"
              ...
              <svg
                onClick={handleDrawer.bind(this, false)}
                className="fixed top-6 right-5 w-6 h-6"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth="3"
            ...
            <nav className="flex flex-col gap-6 pb-6">
              <NavLink
                to="/"
                className="font-sans font-semibold text-xl text-white text-center"
              >
                Home
              </NavLink>
            ...
            <div className="sm:hidden flex flex-row gap-4 items-center justify-center">
              {localStorage.getItem("token") ? (
                <>
                  <div
                    className="px-4 py-2 bg-[#394F87] rounded-lg hover:cursor-pointer"
                ...
                <>
                  <Link
                    to="/login"
                    className="px-4 py-2 ring-1 ring-[#394F87] rounded-lg bg-white w-full"
                  >
                    <div className="font-sans font-semibold text-xl text-[#394F87] text-center">
                      Login
                    </div>
                  </Link>
                  <Link
                    to="/register"
                    className="px-4 py-2 bg-[#394F87] rounded-lg w-full"
                  >
                    <div className="font-sans font-semibold text-xl text-white text-center">
                      Register
                    </div>
                  </Link>
                </>
